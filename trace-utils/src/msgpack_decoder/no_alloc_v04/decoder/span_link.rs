...
use crate::msgpack_decoder::no_alloc_v04::decoder::{
    read_str_map_to_no_alloc_strings, read_string_ref,
};
use crate::msgpack_decoder::no_alloc_v04::error::DecodeError;
use crate::msgpack_decoder::no_alloc_v04::number::read_number;
use crate::no_alloc_span::SpanLink;
        ...
        *buf = value;
        ...
        match key {
            ...
            SpanLinkKey::Tracestate => {
                ...
                span.tracestate = buf_wrapper.create_no_alloc_string(val.as_bytes());
                *buf = next;
            }
