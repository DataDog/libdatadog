...
/// An exporter sending flushing a Concentrator based on a timer and sending stats to the agent
#[derive(Debug)]
pub struct StatsExporter {
    flush_interval: time::Duration,
    concentrator: Arc<Mutex<Concentrator>>,
    endpoint: Endpoint,
...
mod tests {
    ...
    fn get_test_concentrator() -> Concentrator {
