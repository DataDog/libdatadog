...
// Naming convention: parent module (`v04`) = output wire format, file suffix (`_v04`) = input
// span type. This file encodes a [`crate::span::v04::Span`] into the v0.4 msgpack wire format
// (native).
