...
> ⚠️ **This is a vendored fork of [Datadog/rust-tuf](https://github.com/DataDog/rust-tuf),
> itself a fork of [theupdateframework/rust-tuf](https://github.com/theupdateframework/rust-tuf).**
>
> It is published under the name `libdd-tuf-rust` to allow libdatadog to be released on
> crates.io without git dependencies. **Do not use this crate directly** — it is an
> internal implementation detail of the libdatadog workspace.
>
> To update this vendored copy, copy the sources from the Datadog fork at the commit
> used by libdatadog.
