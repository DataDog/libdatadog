...
// };
// // pin traces
// var tracesPtr = GCHandle.Alloc(traces, GCHandleType.Pinned);
// var traceSlice = new ByteSlice
// {
//     Ptr = tracesPtr.AddrOfPinnedObject(),
//     Len = (UIntPtr)traces.Length,
// };
//
// var response = new AgentResponse();
// var sendError = Native.ddog_trace_exporter_send(handle, traceSlice, 0, ref response);
...
static void SetConfig(IntPtr config, CharSlice value, Func<IntPtr, CharSlice, IntPtr> setter)
{
    ...
    Console.WriteLine("Error setting config value: " + errorStruct.Message);
...
internal static class Native
{
    ...
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    internal static extern IntPtr ddog_trace_exporter_config_set_lang_interpreter(IntPtr config, CharSlice interpreter);
    ...
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    internal static extern IntPtr ddog_trace_exporter_send(IntPtr handle, ByteSlice trace, UIntPtr traceCount, ref AgentResponse response);
