...
use crate::profiles::datatypes::{AnyValue, KeyValue, Link2, StackId2, MAX_SAMPLE_TYPES};
...
impl SampleBuilder {
    ...
    pub fn set_stack_id(&mut self, id: StackId2) {
    ...
    pub fn set_link(&mut self, link: Link2) -> Result<(), ProfileError> {
