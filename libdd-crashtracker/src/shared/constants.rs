...
/// Fallback stacktrace marker, used when frame pointer walking is employed on musl.
#[cfg_attr(not(target_env = "musl"), allow(dead_code))]
pub const DD_CRASHTRACK_BEGIN_STACKTRACE_FALLBACK: &str = "DD_CRASHTRACK_BEGIN_STACKTRACE_FALLBACK";
...
/// Fallback stacktrace end marker, used when frame pointer walking is employed on musl.
#[cfg_attr(not(target_env = "musl"), allow(dead_code))]
pub const DD_CRASHTRACK_END_STACKTRACE_FALLBACK: &str = "DD_CRASHTRACK_END_STACKTRACE_FALLBACK";
