...
pub const DD_CRASHTRACK_BEGIN_COMPLETE_STACKTRACE: &str = "DD_CRASHTRACK_BEGIN_COMPLETE_STACKTRACE";
...
pub const DD_CRASHTRACK_END_COMPLETE_STACKTRACE: &str = "DD_CRASHTRACK_END_COMPLETE_STACKTRACE";
