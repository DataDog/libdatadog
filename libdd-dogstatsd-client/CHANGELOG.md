...
## [4.0.0](https://github.com/datadog/libdatadog/compare/libdd-dogstatsd-client-v3.0.0..libdd-dogstatsd-client-v4.0.0) - 2026-07-06

### Changed

- Bump `libdd-common` to a new major version (`^4.1.0` → `^5.0.0`)
