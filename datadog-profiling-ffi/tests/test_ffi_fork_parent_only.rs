...
#[test]
fn test_ffi_fork_parent_only() {
    println!("[test] Starting fork parent-only test");
    ...
    match unsafe { libc::fork() } {
        ...
        0 => {
            ...
            println!("[child] Child process started, exiting immediately");
            std::process::exit(0);
        }
        child_pid => {
            // Parent process - test restart_in_parent
            println!(
            ...
            // Send another sample in parent process
