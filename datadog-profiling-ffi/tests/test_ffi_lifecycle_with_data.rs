...
#[test]
fn test_ffi_lifecycle_with_data() {
    println!("[test] Starting lifecycle test with data processing");
    ...
    // Pause the profiler manager using FFI
    ...
    println!("[test] Lifecycle test with data processing completed successfully");
}
