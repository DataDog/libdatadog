...
impl Builder {
    fn new(target_dir: &str, profile: &str, version: &str) -> Self {
        Builder {
            modules: Vec::new(),
            main_header: "common.h".into(),
            source_lib: ("../target".to_string() + "/" + profile + "/deps").into(),
            source_inc: "../target/include/datadog".into(),
            target_dir: target_dir.into(),
            target_lib: (target_dir.to_string() + "/lib").into(),
            target_include: (target_dir.to_string() + "/include/datadog").into(),
