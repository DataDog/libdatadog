...
pub use libdd_trace_utils::otlp_encoder::{OtlpResourceInfo, map_traces_to_otlp};
...
pub(crate) use grpc_exporter::{
    GrpcExportError, OtlpGrpcTransport, build_grpc_transport, send_otlp_traces_grpc,
};
