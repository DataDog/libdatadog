...
pub struct Label<'a> {
    ...
    /// unit. Consumers may also  interpret units like "bytes" and
    /// "kilobytes" as memory units and units like "seconds" and
    /// "nanoseconds" as time units, and apply appropriate unit conversions
    /// to these.
    pub num_unit: &'a str,
}
