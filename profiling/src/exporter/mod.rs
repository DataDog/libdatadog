...
use ddcommon::{azure_app_services, connector};
use ddcommon_net::dep::{http, hyper, tokio};

use hyper::body::Incoming;

pub use chrono::{DateTime, Utc};
pub use ddcommon::tag::Tag;
pub use ddcommon_net::compat::Endpoint;
pub use http::Uri;
...
impl ProfileExporter {
    ...
    {
        Ok(Self {
            runtime: ddcommon_net::rt::create_current_thread_runtime()?,
            endpoint,
            family: family.into(),
