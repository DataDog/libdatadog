    ...
    pub fn try_into_iter(self) -> io::Result<ObservationsIntoIter> {
        match self.inner {
            ...
            Some(NonEmptyObservations {
                ...
                let agg_it = AggregatedObservationsIntoIter {
...
struct AggregatedObservationsIntoIter {
    iter: std::collections::hash_map::IntoIter<Sample, TrimmedObservation>,
    obs_len: ObservationLength,
}

impl Iterator for AggregatedObservationsIntoIter {
...
impl Drop for AggregatedObservationsIntoIter {
    fn drop(&mut self) {
