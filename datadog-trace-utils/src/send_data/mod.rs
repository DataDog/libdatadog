...
impl SendData {
    ...
    pub async fn send(&self) -> SendDataResult {
        self.send_internal(None, None).await
    }
    ...
    pub async fn send_proxy(
        ...
        self.send_internal(http_proxy, endpoint).await
    }
    ...
    async fn send_internal(
        ...
        if self.use_protobuf() {
            self.send_with_protobuf(http_proxy, endpoint).await
        } else {
            self.send_with_msgpack(http_proxy, endpoint).await
        }
    }
