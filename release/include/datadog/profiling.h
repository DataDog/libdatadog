 ...
 */
DDOG_CHECK_RETURN
struct ddog_prof_ProfileExporter_Result ddog_prof_ReqwestExporter_new(ddog_CharSlice profiling_library_name,
                                                                      ddog_CharSlice profiling_library_version,
                                                                      ddog_CharSlice family,
                                                                      const struct ddog_Vec_Tag *tags,
                                                                      struct ddog_prof_Endpoint endpoint);
 ...
 * allocator that has not already been dropped.
 */
void ddog_prof_ReqwestExporter_drop(struct ddog_prof_ProfileExporter *exporter);
 ...
 */
DDOG_CHECK_RETURN
struct ddog_prof_Result_HttpStatus ddog_prof_ReqwestExporter_send(struct ddog_prof_ProfileExporter *exporter,
                                                                  struct ddog_prof_EncodedProfile *profile,
                                                                  struct ddog_prof_Exporter_Slice_File additional_files,
                                                                  const struct ddog_Vec_Tag *optional_additional_tags,
                                                                  const ddog_CharSlice *optional_internal_metadata_json,
                                                                  const ddog_CharSlice *optional_info_json,
                                                                  struct ddog_CancellationToken *cancel);
