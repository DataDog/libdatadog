 ...
 */
typedef struct struct ddog_OpaqueCancellationToken struct ddog_OpaqueCancellationToken;
...
typedef struct struct ddog_OpaqueCancellationToken ddog_prof_TokioCancellationToken;
