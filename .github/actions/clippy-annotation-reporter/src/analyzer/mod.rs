...
use crate::analyzer::git::{
    get_all_rust_files, get_branch_content, get_changed_files, get_file_content,
};
use anyhow::Result;
...
// Re-export internal items for use within the crate
// pub(crate) use git::{get_file_content, get_changed_files, get_branch_content};
// pub(crate) use annotation::{find_annotations, count_annotations_by_rule,
// count_annotations_by_crate}; pub(crate) use crate_detection::get_crate_for_file;
